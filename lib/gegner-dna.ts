...
export const DNA_CATEGORIES: DnaCategory[] = [
  {
    ...
    questions: [
      ...
      { id: "real-habits_at-cage", label: "Was macht der Gegner am Cage?" },
      { id: "real-habits_in-center", label: "Was macht der Gegner im Center?" },
      ...
      { id: "real-habits_patterns", label: "Welche wiederkehrenden Muster sind besonders auffällig?" },
    ],
  },
  {
    id: "entry-patterns",
    ...
    questions: [
      ...
      { id: "entry-patterns_jab", label: "Nutzt er den Jab als Einstieg?" },
      { id: "entry-patterns_feints", label: "Nutzt er Feints als Einstieg?" },
      { id: "entry-patterns_kicks", label: "Nutzt er Kicks als Einstieg?" },
  ...
  },
  {
    ...
    questions: [
      ...
      { id: "defensive-reactions_clinch", label: "Sucht er unter Druck den Clinch?" },
      { id: "defensive-reactions_shoots", label: "Schießt er als Reaktion auf Angriffe?" },
      { id: "defensive-reactions_retreats-cage", label: "Zieht er sich zum Cage zurück?" },
      { id: "defensive-reactions_exploitable", label: "Welche defensive Reaktion ist ausnutzbar?" },
    ],
  },
  {
    id: "cage-space",
    ...
    questions: [
      ...
      { id: "cage-space_pushes-cage", label: "Drückt er selbst aktiv zum Cage?" },
      { id: "cage-space_pushed-back", label: "Lässt er sich oft zum Cage zurückdrängen?" },
